...
c.url.searchengines['nixpkg'] = "https://search.nixos.org/packages?channel=unstable&from=0&size=50&sort=relevance&type=packages&query={}"
c.url.searchengines['piratebay'] = "https://thepiratebay.org/search/{}"
c.url.searchengines['repository'] = "https://github.com/search?q={}&type=repositories"
c.url.searchengines['translate'] = "https://translate.google.com/?sl=en&tl=it&text={}&op=translate"
